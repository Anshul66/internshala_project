...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO internshala_login (username, password) VALUES (?, ?)";
...
<div class="col-md-4 mx-auto">
        ...
        <p>Please fill this form to create a Hospital account.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have a User account? <a href="user_register.php">Sign up now as a User.</a>.</p>
